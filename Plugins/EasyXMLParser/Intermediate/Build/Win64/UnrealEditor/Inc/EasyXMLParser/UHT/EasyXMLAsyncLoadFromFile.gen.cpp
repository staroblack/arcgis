...
void FEasyXMLAsyncLoadFromFile_Result_DelegateWrapper(const FMulticastScriptDelegate& EasyXMLAsyncLoadFromFile_Result, UEasyXMLElement* XMLObject, const FString& ErrorMessage)
{
	...
	struct Z_CompiledInDeferFile_FID_graphic_arcgisTest_arcgis_Plugins_EasyXMLParser_Source_EasyXMLParser_Public_EasyXMLAsyncLoadFromFile_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_graphic_arcgisTest_arcgis_Plugins_EasyXMLParser_Source_EasyXMLParser_Public_EasyXMLAsyncLoadFromFile_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_graphic_arcgisTest_arcgis_Plugins_EasyXMLParser_Source_EasyXMLParser_Public_EasyXMLAsyncLoadFromFile_h_1166116263(TEXT("/Script/EasyXMLParser"),
		Z_CompiledInDeferFile_FID_graphic_arcgisTest_arcgis_Plugins_EasyXMLParser_Source_EasyXMLParser_Public_EasyXMLAsyncLoadFromFile_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_graphic_arcgisTest_arcgis_Plugins_EasyXMLParser_Source_EasyXMLParser_Public_EasyXMLAsyncLoadFromFile_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
